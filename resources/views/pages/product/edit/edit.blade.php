                ...
                <form   method="POST" action="{{ route('products.update',$product->id) }}" id='updateForm'>
                    ...
                    <div class="form-group">
                        <div class="form-group">
                          ...
                          <input type="text"
                            class="form-control" name="title" id="inp-title" aria-describedby="helpId" value="{{ $product->title}}" placeholder="Enter here" required>
                    ...
                    <div class="form-group">
                       <label for="price">Price</label>
                          <input type="number"
                            class="form-control" value="{{ $product->price}}" name="price" step="0.01" id="inp-price" aria-describedby="inp-price-helpId" placeholder="Enter here" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                          <textarea  id="inp-descripiton-heplId" class="form-control" value="{{ $product->description}}" type="hidden" name="inp-decsription" rows="3"></textarea>
